...
@Composable fun Scanner(){var query by remember{mutableStateOf("")};Column(Modifier.padding(16.dp),verticalArrangement=Arrangement.spacedBy(12.dp)){Text("Scanner",style=MaterialTheme.typography.headlineMedium);Text("Cari kode atau nama emiten.");OutlinedTextField(value=query,onValueChange={query=it},label={Text("Contoh: BBRI")},modifier=Modifier.fillMaxWidth());Button(onClick={}){Text("Analisa")}}}
